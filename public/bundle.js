...
},{"./one":4}],2:[function(require,module,exports){
...
},{"has":17,"xtend":18}],3:[function(require,module,exports){
...
},{"./one":4,"xtend":18}],4:[function(require,module,exports){
"use strict";function one(e,r,n,t){var a=r&&r.type;if(!a)throw new Error("Expected node, not `"+r+"`");if(!has(handlers,a))throw new Error("Cannot compile unknown node `"+a+"`");return handlers[a](e,r,n,t)}var has=require("has");module.exports=one;var handlers={};handlers.root=require("./all"),handlers.heading=require("./types/heading"),handlers.paragraph=require("./types/paragraph"),handlers.comment=require("./types/comment"),handlers.text=require("./types/text"),handlers.strong=require("./types/strong"),handlers.emphasis=require("./types/emphasis"),handlers.delete=require("./types/delete"),handlers.inlineCode=require("./types/inlinecode"),handlers.blockquote=require("./types/blockquote"),handlers.thematicBreak=require("./types/thematic-break");

},{"./all":1,"./types/blockquote":5,"./types/comment":6,"./types/delete":7,"./types/emphasis":8,"./types/heading":9,"./types/inlinecode":10,"./types/paragraph":11,"./types/strong":12,"./types/text":13,"./types/thematic-break":14,"has":17}],5:[function(require,module,exports){
"use strict";function blockquote(o,e){var u="Quotation",t=!1;o&&o.blockquote&&(o.blockquote.macro&&(u=o.blockquote.macro),!0===o.blockquote.useSource&&(t=!0));var r="{"+(e.author||"Anonymous")+"}",l=all(o,e);return"\\begin{"+u+"}"+(t?r:"")+"\n"+l.trim()+"\n\\end{"+u+"}\n\n"}var all=require("../all");module.exports=blockquote;

},{"../all":1}],6:[function(require,module,exports){
...
},{"../escaper":2}],14:[function(require,module,exports){
"use strict";function thematicBreak(t,e,n,r){return"\\horizontalLine\n\n"}module.exports=thematicBreak;
...
"use strict";function plugin(){function e(e,r){return e.indexOf("*[",r)}function r(e,r,t){var i=new RegExp(/[*]\[([^\]]*)\]:\s*(.+)\n*/),n=i.exec(r);return t||(n&&0===n.index?e(n[0])({type:"abbr",data:{hName:"abbr",hProperties:{word:n[1],desc:n[2]}}}):void 0)}function t(e){var r={};visit(e,"element",i(r)),visit(e,n(r))}function i(e){function r(r,t,i){if("p"===r.tagName){for(var n=0;n<r.children.length;++n){var a=r.children[n];"abbr"===a.tagName&&(e[a.properties.word]=a.properties.desc,r.children.splice(n,1),n-=1)}0===r.children.length&&i.children.splice(t,1)}}return r}function n(e){function r(e){return e.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g,"\\$&")}function t(r,t,i){if(0!==Object.keys(e).length&&r.children)for(var a=0;a<r.children.length;++a){var l=r.children[a];if("abbr"!==r.tagName&&"text"===l.type){var c=n.exec(l.value);if(c){var p=l.value.split(n);r.children.splice(a,1);for(var o=0;o<p.length;++o){var s=p[o];e.hasOwnProperty(s)?r.children.splice(a+o,0,{type:"element",tagName:"abbr",properties:{title:e[s]},children:[{type:"text",value:s}]}):r.children.splice(a+o,0,{type:"text",value:s})}}}}}var i=Object.keys(e).map(r).join("|"),n=new RegExp("\\b("+i+")\\b");return t}r.locator=e;var a=this.Parser,l=a.prototype.inlineTokenizers,c=a.prototype.inlineMethods;return l.abbr=r,c.splice(0,0,"abbr"),t}var visit=require("unist-util-visit");module.exports=plugin;

},{"unist-util-visit":20}],20:[function(require,module,exports){
...
},{"unist-util-visit":22}],22:[function(require,module,exports){
...
},{"unist-util-visit":24}],24:[function(require,module,exports){
arguments[4][20][0].apply(exports,arguments)
...
},{"unist-util-visit":31}],31:[function(require,module,exports){
arguments[4][20][0].apply(exports,arguments)
...
},{"url":262}],34:[function(require,module,exports){
...
},{"is-whitespace-character":35}],35:[function(require,module,exports){
...
},{"unist-util-visit":37}],37:[function(require,module,exports){
arguments[4][20][0].apply(exports,arguments)
},{"dup":20}],38:[function(require,module,exports){
"use strict";function locator(r,e){var t=-1,n=!0,i=!1,s=void 0;try{for(var a,o=Object.keys(markers)[Symbol.iterator]();!(n=(a=o.next()).done);n=!0){var l=a.value;if(-1!==(t=r.indexOf(l,e)))return t}}catch(r){i=!0,s=r}finally{try{!n&&o.return&&o.return()}finally{if(i)throw s}}return t}function inlinePlugin(){function r(r,e,t){var n=!0,i=!1,s=void 0;try{for(var a,o=Object.keys(markers)[Symbol.iterator]();!(n=(a=o.next()).done);n=!0){var l=a.value;this.escape.includes(l)||this.escape.push(l)}}catch(r){i=!0,s=r}finally{try{!n&&o.return&&o.return()}finally{if(i)throw s}}var u=e[0],f=r.now();if(f.column+=1,f.offset+=1,markers.hasOwnProperty(u)&&!e.startsWith(u+SPACE)&&!e.startsWith(u+u)){for(var c=1;e[c]!==u&&c<e.length;c++);if(c===e.length)return;if(t)return!0;r(e.substring(0,c+1))({type:markers[u],children:this.tokenizeInline(e.substring(1,c),f),data:{hName:markers[u]}})}}r.locator=locator;var e=this.Parser,t=e.prototype.inlineTokenizers,n=e.prototype.inlineMethods;t.sub_super=r,n.splice(n.indexOf("text"),0,"sub_super")}var SPACE=" ",markers={"~":"sub","^":"sup"};module.exports=inlinePlugin;
...
},{"trim":239}],53:[function(require,module,exports){
...
},{"repeat-string":230}],54:[function(require,module,exports){
...
},{"./implementation":55,"dup":16}],57:[function(require,module,exports){
arguments[4][17][0].apply(exports,arguments)
},{"dup":17,"function-bind":56}],58:[function(require,module,exports){
...
},{"camelcase":45,"has":57,"hastscript":79,"property-information":155,"vfile-location":267}],59:[function(require,module,exports){
...
},{"./one":75}],63:[function(require,module,exports){
...
},{"./all":62,"ccount":46,"comma-separated-tokens":52,"kebab-case":116,"property-information":155,"space-separated-tokens":232,"stringify-entities":235,"xtend":271}],66:[function(require,module,exports){
...
},{"./omission":68,"./one":75,"html-void-elements":81}],67:[function(require,module,exports){
...
},{"./omission":69,"./util/siblings":73,"./util/white-space-left":74,"hast-util-is-element":59,"unist-util-is":257}],68:[function(require,module,exports){
"use strict";exports.opening=require("./opening"),exports.closing=require("./closing");

},{"./closing":67,"./opening":70}],69:[function(require,module,exports){
...
},{"has":57}],70:[function(require,module,exports){
...
},{"./closing":67,"./omission":69,"./util/first":71,"./util/place":72,"./util/siblings":73,"./util/white-space-left":74,"has":57,"hast-util-is-element":59,"unist-util-is":257}],71:[function(require,module,exports){
"use strict";function first(r,t){return after(r,-1,t)}var after=require("./siblings").after;module.exports=first;

},{"./siblings":73}],72:[function(require,module,exports){
...
},{"hast-util-whitespace":78}],74:[function(require,module,exports){
...
},{"hast-util-whitespace":78,"unist-util-is":257}],75:[function(require,module,exports){
...
},{"./all":62,"./comment":63,"./doctype":64,"./element":65,"./raw":76,"./text":77,"has":57}],76:[function(require,module,exports){
"use strict";function raw(e,t){return e.dangerous?t.value:text(e,t)}var text=require("./text");module.exports=raw;

},{"./text":77}],77:[function(require,module,exports){
...
},{"stringify-entities":235,"xtend":271}],78:[function(require,module,exports){
...
},{"camelcase":45,"comma-separated-tokens":52,"hast-util-parse-selector":60,"property-information":155,"space-separated-tokens":232}],80:[function(require,module,exports){
module.exports=[
  "area",
  "base",
  "basefont",
...
},{"./index.json":80}],82:[function(require,module,exports){
...
},{"is-alphabetical":83,"is-decimal":86}],85:[function(require,module,exports){
...
},{"./src/ParseError":96,"./src/Settings":98,"./src/buildTree":103,"./src/parseTree":112,"./src/utils":115}],93:[function(require,module,exports){
...
},{"./ParseError":96,"match-at":118}],94:[function(require,module,exports){
...
},{"./Lexer":93}],95:[function(require,module,exports){
...
},{"./MacroExpander":94,"./ParseError":96,"./environments":106,"./functions":109,"./parseData":111,"./symbols":113,"./unicodeRegexes":114,"./utils":115}],98:[function(require,module,exports){
...
},{"./fontMetrics.js":107}],100:[function(require,module,exports){
...
},{"./domTree":105,"./fontMetrics":107,"./symbols":113,"./utils":115}],101:[function(require,module,exports){
...
},{"./ParseError":96,"./Style":99,"./buildCommon":100,"./delimiter":104,"./domTree":105,"./fontMetrics":107,"./utils":115}],102:[function(require,module,exports){
...
},{"./ParseError":96,"./buildCommon":100,"./fontMetrics":107,"./mathMLTree":110,"./symbols":113,"./utils":115}],103:[function(require,module,exports){
...
},{"./Options":95,"./Settings":98,"./Style":99,"./buildCommon":100,"./buildHTML":101,"./buildMathML":102}],104:[function(require,module,exports){
...
},{"./ParseError":96,"./Style":99,"./buildCommon":100,"./fontMetrics":107,"./symbols":113,"./utils":115}],105:[function(require,module,exports){
...
},{"./unicodeRegexes":114,"./utils":115}],106:[function(require,module,exports){
...
},{"./ParseError":96,"./Style":99,"./parseData":111}],107:[function(require,module,exports){
...
},{"./Style":99,"./fontMetricsData":108,"./unicodeRegexes":114}],108:[function(require,module,exports){
...
},{"./ParseError":96,"./parseData":111,"./utils":115}],110:[function(require,module,exports){
...
},{"./Parser":97}],113:[function(require,module,exports){
...
},{"has":57,"unist-util-visit":261}],120:[function(require,module,exports){
"use strict";module.exports=require("./lib/index.js");

},{"./lib/index.js":147}],121:[function(require,module,exports){
...
},{"./one":148,"trim":239}],122:[function(require,module,exports){
...
},{"./all":121,"unist-builder":254}],123:[function(require,module,exports){
...
},{"./handlers/list":140,"./handlers/thematic-break":146,"./wrap":149}],124:[function(require,module,exports){
...
},{"unist-builder":254}],130:[function(require,module,exports){
...
},{"unist-builder":254}],133:[function(require,module,exports){
...
},{"../failsafe":122,"normalize-uri":150}],134:[function(require,module,exports){
...
},{"normalize-uri":150}],135:[function(require,module,exports){
...
},{"./blockquote":124,"./break":125,"./code":126,"./delete":127,"./emphasis":128,"./footnote":130,"./footnote-reference":129,"./heading":131,"./html":132,"./image":134,"./image-reference":133,"./inline-code":136,"./link":138,"./link-reference":137,"./list":140,"./list-item":139,"./paragraph":141,"./root":142,"./strong":143,"./table":144,"./text":145,"./thematic-break":146}],136:[function(require,module,exports){
...
},{"collapse-white-space":51,"unist-builder":254}],137:[function(require,module,exports){
...
},{"../all":121,"../failsafe":122,"normalize-uri":150}],138:[function(require,module,exports){
...
},{"../all":121,"normalize-uri":150}],139:[function(require,module,exports){
...
},{"../all":121,"../wrap":149,"unist-builder":254}],140:[function(require,module,exports){
...
},{"../all":121,"../wrap":149,"unist-builder":254}],143:[function(require,module,exports){
"use strict";function strong(r,t){return r(t,"strong",all(r,t))}module.exports=strong;var all=require("../all");

},{"../all":121}],144:[function(require,module,exports){
...
},{"../all":121,"../wrap":149,"unist-util-position":258}],145:[function(require,module,exports){
...
},{"trim-lines":237,"unist-builder":254}],146:[function(require,module,exports){
...
},{"./footer":123,"./handlers":135,"./one":148,"mdast-util-definitions":119,"unist-builder":254,"unist-util-generated":255,"unist-util-position":258,"unist-util-visit":261,"xtend":271}],148:[function(require,module,exports){
...
},{"./all":121,"has":57,"unist-builder":254}],149:[function(require,module,exports){
...
},{"unist-builder":254}],150:[function(require,module,exports){
...
},{"character-entities":49,"character-entities-legacy":48,"character-reference-invalid":50,"has":57,"is-alphanumerical":84,"is-decimal":86,"is-hexadecimal":88}],153:[function(require,module,exports){
(function (process){
...
},{"katex":92,"rehype-parse":161,"unified":253,"unist-util-position":258,"unist-util-visit":261}],161:[function(require,module,exports){
...
},{"hast-util-from-parse5":58,"parse5/lib/parser":170,"xtend":271}],162:[function(require,module,exports){
...
},{"../tokenizer":172,"./html":164}],164:[function(require,module,exports){
...
},{"../common/html":164,"../parser/open_element_stack":171,"../tokenizer":172}],168:[function(require,module,exports){
...
},{"../common/unicode":166}],169:[function(require,module,exports){
...
},{"../common/doctype":162,"../common/foreign_content":163,"../common/html":164,"../common/merge_options":165,"../common/unicode":166,"../location_info/parser_mixin":167,"../tokenizer":172,"../tree_adapters/default":175,"./formatting_element_list":169,"./open_element_stack":171}],171:[function(require,module,exports){
...
},{"../common/html":164}],172:[function(require,module,exports){
...
},{"../common/unicode":166,"../location_info/tokenizer_mixin":168,"./named_entity_trie":173,"./preprocessor":174}],173:[function(require,module,exports){
...
},{"../common/unicode":166}],175:[function(require,module,exports){
...
},{"hast-util-to-html":61,"xtend":271}],177:[function(require,module,exports){
...
},{"trim-trailing-lines":238}],178:[function(require,module,exports){
...
},{"./block":177,"./inline":179}],179:[function(require,module,exports){
...
},{"./lib/parser.js":194,"unherit":252,"xtend":271}],181:[function(require,module,exports){
module.exports=[
  "address",
  "article",
  "aside",
...
},{"parse-entities":152}],183:[function(require,module,exports){
...
},{"./block-elements":181}],184:[function(require,module,exports){
...
},{"unist-util-remove-position":259,"xtend":271}],194:[function(require,module,exports){
...
},{"./decode":182,"./defaults":183,"./parse":193,"./set-options":195,"./tokenize/auto-link":196,"./tokenize/blockquote":197,"./tokenize/break":198,"./tokenize/code-fenced":199,"./tokenize/code-indented":200,"./tokenize/code-inline":201,"./tokenize/definition":202,"./tokenize/delete":203,"./tokenize/emphasis":204,"./tokenize/escape":205,"./tokenize/footnote-definition":206,"./tokenize/heading-atx":207,"./tokenize/heading-setext":208,"./tokenize/html-block":209,"./tokenize/html-inline":210,"./tokenize/link":211,"./tokenize/list":212,"./tokenize/newline":213,"./tokenize/paragraph":214,"./tokenize/reference":215,"./tokenize/strong":216,"./tokenize/table":217,"./tokenize/text":218,"./tokenize/thematic-break":219,"./tokenize/url":220,"./tokenize/yaml":221,"./tokenizer":222,"./unescape":223,"state-toggle":233,"vfile-location":267,"xtend":271}],195:[function(require,module,exports){
...
},{"./defaults":183,"markdown-escapes":117,"xtend":271}],196:[function(require,module,exports){
...
},{"../locate/tag":191,"parse-entities":152}],197:[function(require,module,exports){
...
},{"../util/interrupt":226,"trim":239}],198:[function(require,module,exports){
...
},{"../locate/break":184}],199:[function(require,module,exports){
...
},{"trim-trailing-lines":238}],200:[function(require,module,exports){
...
},{"repeat-string":230,"trim-trailing-lines":238}],201:[function(require,module,exports){
...
},{"../locate/code-inline":185,"is-whitespace-character":90}],202:[function(require,module,exports){
...
},{"../util/normalize":227,"is-whitespace-character":90}],203:[function(require,module,exports){
...
},{"../locate/delete":186,"is-whitespace-character":90}],204:[function(require,module,exports){
...
},{"../locate/emphasis":187,"is-whitespace-character":90,"is-word-character":91,"trim":239}],205:[function(require,module,exports){
...
},{"../locate/escape":188}],206:[function(require,module,exports){
...
},{"../util/normalize":227,"is-whitespace-character":90}],207:[function(require,module,exports){
...
},{"../util/html":225}],210:[function(require,module,exports){
...
},{"../locate/tag":191,"../util/html":225,"is-alphabetical":83}],211:[function(require,module,exports){
...
},{"../locate/link":189,"has":57,"is-whitespace-character":90}],212:[function(require,module,exports){
...
},{"../util/get-indentation":224,"../util/interrupt":226,"../util/remove-indentation":228,"is-decimal":86,"repeat-string":230,"trim":239}],213:[function(require,module,exports){
...
},{"is-whitespace-character":90}],214:[function(require,module,exports){
...
},{"../util/interrupt":226,"is-decimal":86,"trim":239,"trim-trailing-lines":238}],215:[function(require,module,exports){
...
},{"../locate/link":189,"../util/normalize":227,"is-whitespace-character":90}],216:[function(require,module,exports){
...
},{"../locate/strong":190,"is-whitespace-character":90,"trim":239}],217:[function(require,module,exports){
...
},{"is-whitespace-character":90}],218:[function(require,module,exports){
...
},{"../locate/url":192,"is-whitespace-character":90,"parse-entities":152}],221:[function(require,module,exports){
...
},{"collapse-white-space":51}],228:[function(require,module,exports){
...
},{"./get-indentation":224,"repeat-string":230,"trim":239}],229:[function(require,module,exports){
...
},{"mdast-util-to-hast":120}],230:[function(require,module,exports){
...
},{"path":153}],232:[function(require,module,exports){
...
},{"trim":239}],233:[function(require,module,exports){
...
"use strict";module.exports={af:"“”‘’",sq:"„“‘’",az:"«»‹›",eu:"«»‹›",be:"«»“”",bg:"„“’’",ca:"«»“”","zh-Hans":"“”‘’",hr:"„”‘’",cs:"„“‚‘",da:"»«›‹",nl:"‘’“”","en-uk":"‘’“”","en-us":"“”‘’",eo:"“”‘’",et:"„“«»",fil:"“”‘’",fi:"””’’",fr:"«»“”","fr-sw":"«»‹›",ka:"„““”",de:"„“‚‘","de-sw":"«»‹›",el:"«»“”",he:"\"\"''",hu:"„”»«",is:"„“‚‘",id:"“”‘’",ga:"“”‘’",it:"«»“”","it-sw":"«»‹›",ko:"“”‘’",lv:"«»„“",mk:"„“’‘",no:"«»’’",pl:"„”«»","pt-br":"“”‘’","pt-pl":"«»“”",ro:"„”«»",ru:"«»„“",sr:"„”’’",sk:"„“‚‘",sl:"„“‚‘",es:"«»“”",sv:"””’’",th:"“”‘’",tr:"“”‘’",uk:"«»„“",cy:"‘’“”"};

},{}],248:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function typographicQuotes(){var e=arguments.length<=0||void 0===arguments[0]?"":arguments[0],t=arguments.length<=1||void 0===arguments[1]?{}:arguments[1],r=t.locale;if(-1===Object.keys(_typographicQuotesL10nDb2.default).indexOf(r))return e;var o=_typographicQuotesL10nDb2.default[r],u="",i=/(^|\s)(?:"(.*?)"|'(.*?)')(\s|$|\.|,|\?|!)/gim,n=function(e,t){return function(o){var n=arguments.length<=1||void 0===arguments[1]?"":arguments[1],p=arguments.length<=2||void 0===arguments[2]?"":arguments[2],l=arguments.length<=3||void 0===arguments[3]?"":arguments[3],a=arguments.length<=4||void 0===arguments[4]?"":arguments[4],s=p+l;return t&&(s=s.replace(i,t)),"fr"===r&&(u=" "),""+n+e[0]+u+s+u+e[1]+a}};return e.replace(i,n(o.slice(0,2),n(o.slice(2,4))))}Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=typographicQuotes;var _typographicQuotesL10nDb=require("typographic-quotes-l10n-db"),_typographicQuotesL10nDb2=_interopRequireDefault(_typographicQuotesL10nDb);module.exports=exports.default;

},{"typographic-quotes-l10n-db":247}],249:[function(require,module,exports){
...
},{"object-assign":151}],255:[function(require,module,exports){
...
},{"is-empty":87,"util":266}],257:[function(require,module,exports){
...
},{"unist-util-visit":261}],260:[function(require,module,exports){
...
},{"./util":263,"punycode":156,"querystring":159}],263:[function(require,module,exports){
...
},{"dup":82}],265:[function(require,module,exports){
...
},{"./support/isBuffer":265,"_process":154,"inherits":264}],267:[function(require,module,exports){
...
},{"_process":154,"is-buffer":85,"path":153,"replace-ext":231,"unist-util-stringify-position":260}],269:[function(require,module,exports){
...
},{"dup":18}],272:[function(require,module,exports){
"use strict";function plugin(){function t(t){s=r.reduce(function(t,i){return t.use("string"==typeof i?require(i):i)},textr(o)),visit(t,"text",i)}function i(t){t.value=s(t.value)}var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{},u=e.plugins,r=void 0===u?[]:u,n=e.options,o=void 0===n?{}:n,s=void 0;return t}var visit=require("unist-util-visit"),textr=require("textr");module.exports=plugin;

},{"textr":236,"unist-util-visit":261}]},{},[42])(42)
});
